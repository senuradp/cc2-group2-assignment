...
@section('title', 'Hotel Portal - Register')
...
<div class="form-wrapper">
    ...
    <form method="POST" action="register">
        ...
        <div class="form-group">
            <input type="text" class="form-control" value="{{ old('contact') }}" name="contact" placeholder="Contact number" required autofocus>
            @error('contact')
                <small class="form-text text-danger">{{ $message }}</small>
            @enderror
        </div>
